  ...
  return (
    <div className="min-h-screen p-4 md:p-6 no-scrollbar">
      <div className="px-4 py-3 max-[650px]:p-0 max-[650px]:mt-6 flex justify-between items-end max-[650px]:flex-col max-[650px]:items-start gap-2">
        ...
        {
          showAddEbook ? (
            <button className="cursor-pointer w-[150px] h-[40px] rounded-lg bg-[#FFc300] dark:text-black flex items-center justify-center gap-2 "
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div className="space-y-6">
              <div className="max-[650px]:bg-none rounded-lg max-[650px]:shadow-none p-4 max-[650px]:p-0 border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-6">
                  ...
                  <FormField label="Book Category" error={errors.courseLocation?.message} className="mt-8">
                    <select
                  ...
                  >
                    <div className="quill-container">
                      <ReactQuill
                        ...
                        onChange={(value) => setValue("courseDescription", value)}
            ...
            <div className="space-y-6">
              <div className="max-[650px]:bg-none rounded-lg max-[650px]:shadow-none p-4 max-[650px]:p-0 border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-6">
                  <FormField label="Course Category" error={errors.courseCategory?.message} className="mt-8">
                    <select
                ...
                <button
                  disabled={isLoading}
                  className={`w-full h-12 rounded-lg text-lg font-semibold transition-all duration-200 mt-4 ${isLoading
      ...
      {!showAddEbook && (!analyticsData?.products || analyticsData.products.length === 0) && (
        <EmptyState title="No course uploaded yet" description="Start adding your courses here" />
      )}
    </div>
  );
};
