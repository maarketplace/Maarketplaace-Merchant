...
const UploadCourse = () => {
    ...
    const { register, handleSubmit, formState: { errors, isValid }, setValue, reset, watch } = form;
    ...
    const onSubmit: SubmitHandler<IAddCourse> = (data) => {
        ...
        mutate({ ...others, courseImage: courseImage && courseImage.length > 0 ? courseImage : null });
    };
                ...
                <div className="grid lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white max-[650px]:bg-none dark:bg-gray-800 rounded-lg shadow-sm max-[650px]:shadow-none border max-[650px]:border-none border-gray-200 dark:border-gray-700 p-4">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mb-2">(amount to remove from the original price)</p>
                                    <input
                                    ...
                                    {errors.courseDiscountedPrice?.message && (
                                        <p className="text-red-500 text-sm mt-1">{errors.courseDiscountedPrice?.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-gray-500 mb-2">(payment price for buyers)</p>
                                    <input
                                        type="number"
                                        value={paymentPrice}
                                        disabled
                                ...
                                <div>
                                    ...
                                    {errors.courseLocation?.message && (
                                        <p className="text-red-500 text-sm mt-1">{errors.courseLocation?.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {errors.courseDescription?.message && (
                                        <p className="text-red-500 text-sm mt-2">{errors.courseDescription?.message}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {errors.courseCategory?.message && (
                                        <p className="text-red-500 text-sm mt-1">{errors.courseCategory?.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {errors.courseSubCategory?.message && (
                                        <p className="text-red-500 text-sm mt-1">{errors.courseSubCategory?.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    {errors.courseURL?.message && (
                                        <p className="text-red-500 text-sm mt-1">{errors.courseURL?.message}</p>
                                    )}
                                </div>
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        {selectedFileName ? (
                                            <div className="text-center">
                                                <p className="text-sm font-medium text-gray-900 dark:text-white">{selectedFileName}</p>
                                    ...
                                    {errors.courseImage?.message && (
                                        <p className="text-red-500 text-sm mt-1">{errors.courseImage?.message}</p>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className={`w-full h-12 rounded-lg text-lg font-semibold transition-all duration-200 ${isLoading || !isValid
