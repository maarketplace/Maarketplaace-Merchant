...
function UploadEbook() {
    ...
    const { register, watch, handleSubmit, formState: { errors, isValid }, setValue, reset } = form;
    ...
    const onSubmit: SubmitHandler<IAddEbook> = useCallback(async (data) => {
    ...
    const onDropEbook = useCallback((acceptedFiles: File[]) => {
        if (acceptedFiles.length > 0) {
            const fileList = new DataTransfer();
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-6 ">
                            <div className="bg-white max-[650px]:bg-none dark:bg-gray-800 rounded-lg shadow-sm max-[650px]:shadow-none p-4 border max-[650px]:border-none border-gray-200 dark:border-gray-700">
                                ...
                                <FormField label="Book Description" error={errors.productDescription?.message}>
                        ...
                        <div className="bg-white max-[650px]:bg-none dark:bg-gray-800 rounded-lg shadow-sm max-[650px]:shadow-none p-4 border max-[650px]:border-none border-gray-200 dark:border-gray-700">
                                ...
                                {selectedCategory && (
                                    <FormField label="Book Subcategory" error={errors.subCategory?.message}>
                                        <select
