...
const Store = () => {
  ...
  useEffect(() => {
    if (
      ...
      Array.isArray(storeData.data.data.data)
    ) {
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mt-8">
          ...
          {allProduct.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {allProduct.map((product) => (
                <ProductCard
                  ...
                  product={product}
                  onQuicksClick={() =>
                    navigate(`/dashboard/quicks/${product._id}`)
                  }
                  onEditClick={() =>
            ...
            <EmptyState
              title="No Product in store yet"
              description="Start adding products to showcase your store"
            />
          )}
        </div>
