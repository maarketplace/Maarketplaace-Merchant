...
export const merchantAddProductToCart = async ({
  id,
  data,
}: {
  id: string;
...
export const merchantComment = async ({
  id,
  comment,
}: {
  id: string | undefined;
  ...
  return await axiosInstance.post(`/comment/merchant/products/${id}`, {
    comment,
  });
};
...
export const merchantResetPassword = async (data: {
  id: string | undefined;
  password: string;
}) => {
  return await axiosInstance.patch(`/merchant/ps-change/${data.id}`, {
...
export const withdrawFunds = async ({
  ...
  return await axiosInstance.post(`/accounts/request/accounts/${id}`, {
    amount,
  });
};
